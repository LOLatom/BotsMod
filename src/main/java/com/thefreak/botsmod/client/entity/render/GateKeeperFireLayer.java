...
public class GateKeeperFireLayer extends GeoLayerRenderer {
    private static final ResourceLocation LAYER = new ResourceLocation("botsmod", "textures/entities/gate_keeper_fire_layer.png");
    private static final ResourceLocation MODEL = new ResourceLocation("botsmod", "geo/gate_keeper.geo.json");

    public GateKeeperFireLayer(IGeoRenderer entityRendererIn) {
