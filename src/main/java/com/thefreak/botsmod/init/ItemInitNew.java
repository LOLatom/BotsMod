...
public class ItemInitNew {
    ...
    public static final RegistryObject<Item> COOKED_PILOVE_FRUIT = ITEMS.register("cooked_pilove_fruit", () -> new Item(new Item.Properties().tab(BotsMod.BotsfoodItemGroup.food).food(new Food.Builder().nutrition(7).saturationMod(5F).build())));

    public static final RegistryObject<Item> PILOVE_FRUIT = ITEMS.register("pilove_fruit", () -> new PiloveFruitItem(new Item.Properties().tab(BotsMod.BotsfoodItemGroup.food).food(new Food.Builder().nutrition(5).saturationMod(3F).effect( () -> new EffectInstance(EffectInitNew.EXPLOSIVE_EFFECT.get(), 400, 1),1.0F).fast().build())));

    public static final RegistryObject<Item> DREAM_BERRY = ITEMS.register("dream_berry", () -> new DreamBerryItem(new Item.Properties().tab(BotsMod.BotsfoodItemGroup.food).food(new Food.Builder().nutrition(4).saturationMod(5F).alwaysEat().build())));
    ...
    public static final RegistryObject<Item> RAW_TIPPY_LIZARD = ITEMS.register("raw_tippy_lizard", () -> new Item(new Item.Properties().tab(BotsMod.BotsfoodItemGroup.food).food(new Food.Builder().nutrition(2).saturationMod(0.5F).effect( () -> new EffectInstance(Effects.HUNGER, 400, 2),1.0F).build())));

    public static final RegistryObject<Item> COOKED_TIPPY_LIZARD = ITEMS.register("cooked_tippy_lizard", () -> new Item(new Item.Properties().tab(BotsMod.BotsfoodItemGroup.food).food(new Food.Builder().nutrition(4).saturationMod(3F).build())));

    public static final RegistryObject<Item> RAW_TIPPY_LIZARD_BITS = ITEMS.register("raw_tippy_lizard_bits", () -> new Item(new Item.Properties().tab(BotsMod.BotsfoodItemGroup.food).food(new Food.Builder().nutrition(1).saturationMod(0F).effect( () -> new EffectInstance(Effects.HUNGER, 400, 2),1.0F).fast().build())));

    public static final RegistryObject<Item> COOKED_TIPPY_LIZARD_BITS = ITEMS.register("cooked_tippy_lizard_bits", () -> new Item(new Item.Properties().tab(BotsMod.BotsfoodItemGroup.food).food(new Food.Builder().nutrition(3).saturationMod(2.5F).fast().build())));

    public static final RegistryObject<Item> GLAZED_TIPPY_LIZARD_BITS = ITEMS.register("glazed_tippy_lizard_bits", () -> new Item(new Item.Properties().tab(BotsMod.BotsfoodItemGroup.food).food(new Food.Builder().nutrition(4).saturationMod(3.5F).fast().build())));

    public static final RegistryObject<Item> PUFF_WORM_EGGS = ITEMS.register("puff_worm_eggs", () -> new PuffWormEggs(new Item.Properties().tab(BotsMod.BotsfoodItemGroup.food).food(new Food.Builder().nutrition(1).saturationMod(1.5F).effect( () -> new EffectInstance(Effects.CONFUSION, 200, 1),1.0F).fast().build())));
