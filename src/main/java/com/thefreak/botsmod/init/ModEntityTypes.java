...
public class ModEntityTypes {
	...
	public static final RegistryObject<EntityType<GiantTardigradeEntity>> GIANT_TARDIGRADE = ENTITY.register("giant_tardigrade", () ->
			EntityType.Builder.<GiantTardigradeEntity>of(GiantTardigradeEntity::new, MobCategory.WATER_AMBIENT).sized(4.5F,4F).build(new ResourceLocation(BotsMod.MOD_ID,"giant_tardigrade").toString()));
	...
	public static final RegistryObject<EntityType<DrainedEntity>> DRAINED = ENTITY.register("drained", () ->
			EntityType.Builder.<DrainedEntity>of(DrainedEntity::new, MobCategory.AMBIENT).sized(0.8F,2.2F).build(new ResourceLocation(BotsMod.MOD_ID,"drained").toString()));

	public static final RegistryObject<EntityType<DrainedChiefEntity>> DRAINED_CHIEF = ENTITY.register("drained_chief", () ->
			EntityType.Builder.<DrainedChiefEntity>of(DrainedChiefEntity::new, MobCategory.AMBIENT).sized(2F,2.9F).build(new ResourceLocation(BotsMod.MOD_ID,"drained_chief").toString()));
	...
	public static final RegistryObject<EntityType<PinkPurifiedSaltItemEntity>> PINK_PURIFIED_SALT_ITEM_ENTITY = ENTITY.register("pink_purified_salt_item_entity", () ->
			EntityType.Builder.<PinkPurifiedSaltItemEntity>of(PinkPurifiedSaltItemEntity::new, MobCategory.MISC).sized(0.1F,0.1F).build(new ResourceLocation(BotsMod.MOD_ID,"pink_purified_salt_item_entity").toString()));

	//MISC_SPECIAL

	public static final RegistryObject<EntityType<BansheeScreamEntity>> BANSHEE_SCREAM = ENTITY.register("banshee_scream", () ->
			EntityType.Builder.<BansheeScreamEntity>of(BansheeScreamEntity::new, MobCategory.MISC).sized(0.3F,0.3F).build(new ResourceLocation(BotsMod.MOD_ID,"banshee_scream").toString()));

	public static final RegistryObject<EntityType<SaltedArrow>> SALTED_ARROW = ENTITY.register("salted_arrow", () ->
			EntityType.Builder.<SaltedArrow>of(SaltedArrow::new, MobCategory.MISC).sized(0.5F, 0.5F).clientTrackingRange(4).updateInterval(20).build(new ResourceLocation(BotsMod.MOD_ID,"salted_arrow").toString()));
