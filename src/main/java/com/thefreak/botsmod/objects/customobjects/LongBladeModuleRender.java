...
import com.thefreak.botsmod.client.Rendering.models.LongBladeModuleModel;
...
public class LongBladeModuleRender extends ProstheticRender{
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(BotsMod.MOD_ID, "textures/prosthetic/iron_long_blade_module_texture.png");

    public LongBladeModuleRender() {
    ...
    public void renderProsthetic(EntityModelSet modelSet, ItemStack stack, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight, Player player, float pLimbSwing, float pLimbSwingAmount, float pPartialTicks, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch, EntityModel parentModel) {
        ...
        LongBladeModuleModel model = new LongBladeModuleModel<>(modelSet.bakeLayer(BotsModLayers.LONG_BLADE_MODULE));
