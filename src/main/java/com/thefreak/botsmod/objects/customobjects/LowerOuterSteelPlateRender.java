...
import com.thefreak.botsmod.client.Rendering.models.LowerOuterSteelPlateModel;
...
public class LowerOuterSteelPlateRender extends ProstheticRender{
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(BotsMod.MOD_ID, "textures/prosthetic/lower_outer_steel_plate.png");

    public LowerOuterSteelPlateRender() {
    ...
    public void renderProsthetic(EntityModelSet modelSet, ItemStack stack, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight, Player player, float pLimbSwing, float pLimbSwingAmount, float pPartialTicks, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch, EntityModel parentModel) {
        ...
        LowerOuterSteelPlateModel model = new LowerOuterSteelPlateModel<>(modelSet.bakeLayer(BotsModLayers.LOWER_OUTER_STEEL_PLATE));
