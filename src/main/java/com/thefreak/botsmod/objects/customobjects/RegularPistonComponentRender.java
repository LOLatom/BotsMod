...
public class RegularPistonComponentRender extends ProstheticRender{
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(BotsMod.MOD_ID, "textures/prosthetic/regular_piston_texture.png");


    public RegularPistonComponentRender() {
    ...
    public void renderProsthetic(EntityModelSet modelSet, ItemStack stack, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight, Player player, float pLimbSwing, float pLimbSwingAmount, float pPartialTicks, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch, EntityModel parentModel) {
        ...
        JointPistonComponentModel model = new JointPistonComponentModel<>(modelSet.bakeLayer(BotsModLayers.REGULAR_PISTON));
