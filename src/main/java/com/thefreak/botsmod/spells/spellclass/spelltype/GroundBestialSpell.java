...
public class GroundBestialSpell extends AbstractSpell {


    public GroundBestialSpell(ItemStack usedItemStack, boolean f1state, boolean f2state, boolean f3state, boolean f4state, boolean blade, @Nullable UseOnContext context) {
    ...
    public ResourceLocation getIconLocation() {
        return new ResourceLocation(BotsMod.MOD_ID,"textures/gui/spell/ground_bestial_spell.png");
    }
