package com.thefreak.botsmod.spells.spellclass.spelltype.hurtspell;
...
public class FireHurtSpell extends AbstractSpell {
    public FireHurtSpell(ItemStack usedItemStack, boolean f1state, boolean f2state, boolean f3state, boolean f4state, boolean blade, @Nullable UseOnContext context) {
    ...
    public void Execute(Player player, Level level, InteractionHand hand, @Nullable UseOnContext context) {
        getTarget().setRemainingFireTicks(100);
