...
public class CenoGoblinAnvilTileEntity extends BlockEntity implements ITileEntityBase, ITickableTileEntity {

    @Nonnull
    private ItemStack stack = Items.AIR.getDefaultInstance().getContainerItem();
    ...
    @Override
    public void load(BlockState p_230337_1_, CompoundTag nbt) {
