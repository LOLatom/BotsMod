...
public class PostMortalAltarTileEntity extends TileEntity implements IAnimatable {
    ...
    public PostMortalAltarTileEntity(TileEntityType<?> p_i48289_1_) {
        super(p_i48289_1_);
    }

    public PostMortalAltarTileEntity() {
        this(ModTileEntityTypes.POST_MORTAL_ALTAR_TILE_ENTITY.get());
    }
