...
public class CookingPotLiquidFirstLayerModel extends AnimatedGeoModel<CookingPotTileEntity> {
    @Override
    public ResourceLocation getModelLocation(CookingPotTileEntity cookingPotTileEntity) {
        return new ResourceLocation(BotsMod.MOD_ID, "geo/cooking_pot_liquid_firstlayer.geo.json");
    }
