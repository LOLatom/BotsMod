...
public class CookingPotLiquidSecondLayerModel extends AnimatedGeoModel<CookingPotTileEntity> {
    @Override
    public ResourceLocation getModelLocation(CookingPotTileEntity cookingPotTileEntity) {
        return new ResourceLocation(BotsMod.MOD_ID, "geo/cooking_pot_liquid_secondlayer.geo.json");
    }
